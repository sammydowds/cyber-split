    ...
    <section className="relative bg-black text-white overflow-hidden font-inter h-screen w-screen overflow-hidden flex items-center">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <motion.h1
            className="text-6xl md:text-8xl font-black mb-6 tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-[#fde047] to-white"
          ...
          >
            Elevate your training with proven weight split programs generated by
            you.
          </motion.p>
          <motion.div
